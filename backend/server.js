...
// Live Payloqa payments host is payment.payloqa.com (singular).
// payments.payloqa.com and api.payloqa.com do not resolve in DNS.
const PAYLOQA_PAYMENTS_URL_DEFAULT = 'https://payment.payloqa.com/api/v1/payments';
...
const PAYLOQA_CONFIG = {
  ...
  paymentsBaseURL: process.env.PAYLOQA_PAYMENTS_URL || PAYLOQA_PAYMENTS_URL_DEFAULT,
};
